...
** normie friendly where feasible
- works on windows
- disable lock files
- no evil by default
...
I see users of config frameworks learning the way of the config
framework,
I am not sure how much this helps you in your emacs journey.
...
** simple mode line
I am worried that a big mode-line with vcs display would be slow on windows.
...
In my opinion these are more complex than simple-easy-emacs.
